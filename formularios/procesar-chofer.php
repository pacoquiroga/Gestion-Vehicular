...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['foto'])) {
        ...
        if ($tipo_imagen == "image/jpeg" || $tipo_imagen == "image/jpg" || $tipo_imagen == "image/png") {
            ...
            $carpeta_destino = $_SERVER['DOCUMENT_ROOT'] . '/Gestion-Vehicular/img/';
        ...
        <?php else: ?>
            <section class="informacion">
                ...
                <article>
                    ...
                    <p><strong class="titulo">Fecha de entrada: </strong>
                        <?php echo $fecha_entrada; ?>
                    </p>
                </article>
                <article style=" text-align:center; ">
                    <h1>Foto del Chofer</h1>
                    <img src="../img/<?php echo $nombre_imagen; ?>" width="50%" alt="foto-chofer">
