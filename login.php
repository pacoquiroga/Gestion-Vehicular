...
<body>
    ...
    <section class="login-container">
        <article >
            ...
            <img src="img/Usuario.png" alt="Logo Gestion Vehicular" width=10% height=5% >
        </article>
        <form action="login.php" method="post">
            <label for="username">Usuario:</label>
            <input type="text" id="username" name="username" required value="<?php echo htmlspecialchars($emailAnterior); ?>">
